...
public class CAxAADataStoreBasedDFAReaderImpl extends
	...
	public static Collection<Type> DEFAULT_ALLOWED_ACTIVITY_ACTIVITY_DATA_STRUCTURES = EnumSet.of(Type.LOSSY_COUNTING,
			Type.FREQUENT_ALGORITHM, Type.SPACE_SAVING, Type.LOSSY_COUNTING_BUDGET, Type.SLIDING_WINDOW, Type.FORWARD_EXPONENTIAL_DECAY, Type.BACKWARD_EXPONENTIAL_DECAY);
	...
	public static Collection<Type> DEFAULT_ALLOWED_CASE_ACTIVITY_DATA_STRUCTURES = EnumSet.of(
			...
			Type.COUNT_MIN_SKETCH_POINTER, Type.LOSSY_COUNTING_BUDGET_POINTER, Type.SLIDING_WINDOW_POINTER, Type.FORWARD_EXPONENTIAL_DECAY_POINTER, Type.BACKWARD_EXPONENTIAL_DECAY_POINTER);
